...
@Autonomous (name = "NewTourneyAuton", group = "0", preselectTeleOp = "TourneyTele")

public class NewTourneyAuton extends LinearOpMode {
                ...
                case SCORE:
                    switch (score) {
                        case EXTEND:
                            ...
                            if (cycles < 6) {
                                robot.intakeOuttake.horizontal.backwardLeft.setPosition(linearProfile(875, myTimer.time(), 875, ((BACKWARD_LEFT_IN + BACKWARD_LEFT_OUT) / 2), (BACKWARD_LEFT_OUT - .124)));
                                robot.intakeOuttake.horizontal.backwardRight.setPosition(linearProfile(875, myTimer.time(), 875, ((BACKWARD_RIGHT_IN + BACKWARD_RIGHT_OUT) / 2), BACKWARD_RIGHT_OUT + .124));
                            } else {
                                robot.intakeOuttake.horizontal.backwardLeft.setPosition(linearProfile(875, myTimer.time(), 875, BACKWARD_LEFT_IN, (BACKWARD_LEFT_OUT - .124)));
                                robot.intakeOuttake.horizontal.backwardRight.setPosition(linearProfile(875, myTimer.time(), 875, BACKWARD_RIGHT_IN, BACKWARD_RIGHT_OUT + .124));
                            }
...
//                            }
                            ...
                            if (myTimer.time() > 975) {
                                robot.intakeOuttake.horizontal.backwardLeft.setPosition(BACKWARD_LEFT_OUT - .124);
                                robot.intakeOuttake.horizontal.backwardRight.setPosition(BACKWARD_RIGHT_OUT + .124);
                                myTimer.reset();
                                reached = true;
                                score = Score.GRAB;
                            }
